---
title: "Regressionstest 101 vs 102"
...
It could look like the bug have been fixed on the newest version, just looking at the data structure. 
...
Lets remove the rows and columns that don't appear in old_clean so we can compare the data sets mere exactly.  
